...
const ANDROID_DEPENDENCIES: Array = [ "androidx.appcompat:appcompat:1.7.1", "com.google.android.gms:play-services-mlkit-barcode-scanning:18.3.1", "com.google.zxing:core:3.5.4" ]
